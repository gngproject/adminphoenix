      ...
      <div class="card-header p-1">
        <ul class="navbar-nav">
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('adminmaster.advertise.show') }}" class="nav-link active">Active Advertise</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('adminmaster.advertise.shownonactive') }}" class="nav-link">Non-Active Advertise</a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <div class="col-12">
        <div class="card mt-2">
          <div class="card-header">
            <div class="row">
                <h3 class="card-title col-md-10 col-sm-12 my-2 ">Active Data Advertise</h3>
